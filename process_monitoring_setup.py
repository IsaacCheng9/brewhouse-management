...
class Ui_dialog_monitoring(object):
    ...
    def setupUi(self, dialog_monitoring):
        ...
        self.grid_layout_start_process.addWidget(
            self.btn_start_conditioning, 10, 0, 1, 1,
        ...
        self.grid_layout_start_process.addWidget(
            self.btn_start_fermentation, 4, 3, 1, 1,
            QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop)
        ...
        self.grid_layout_start_process.addWidget(
            self.btn_start_bottling, 10, 3, 1, 1,
            QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop)
        ...
        self.grid_layout_start_process.addWidget(
            self.btn_start_hot_brew, 4, 0, 1, 1,
            QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop)
    ...
    def retranslateUi(self, dialog_monitoring):
        ...
        self.btn_send_bottles.setText(_translate(
            "dialog_monitoring", "Send Bottles to Inventory"))
