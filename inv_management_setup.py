...
class Ui_dialog_inv_management(object):
    def setupUi(self, dialog_inv_management):
        ...
        self.scroll_area_widget_contents.setGeometry(QtCore.QRect(0, 0, 778, 778))
        ...
        self.vert_layout_inv_management.setObjectName("vert_layout_inv_management")
        ...
        self.lbl_update_inv_volume = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.lbl_update_inv_volume.setObjectName("lbl_update_inv_volume")
        self.grid_layout_update_inv.addWidget(self.lbl_update_inv_volume, 2, 0, 1, 1)
        self.lbl_update_inv_recipe = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.lbl_update_inv_recipe.setObjectName("lbl_update_inv_recipe")
        self.grid_layout_update_inv.addWidget(self.lbl_update_inv_recipe, 1, 0, 1, 1)
        self.combo_box_update_inv_recipe = QtWidgets.QComboBox(self.verticalLayoutWidget)
        self.combo_box_update_inv_recipe.setObjectName("combo_box_update_inv_recipe")
        self.combo_box_update_inv_recipe.addItem("")
        self.combo_box_update_inv_recipe.addItem("")
        self.combo_box_update_inv_recipe.addItem("")
        self.grid_layout_update_inv.addWidget(self.combo_box_update_inv_recipe, 1, 1, 1, 1)
        self.line_edit_update_inv_volume = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.line_edit_update_inv_volume.setMaxLength(13)
        self.line_edit_update_inv_volume.setObjectName("line_edit_update_inv_volume")
        self.grid_layout_update_inv.addWidget(self.line_edit_update_inv_volume, 2, 1, 1, 1)
        ...
        self.grid_layout_add_order.addWidget(self.lbl_add_order_recipe, 2, 0, 1, 1)
        self.combo_box_add_order_recipe = QtWidgets.QComboBox(self.verticalLayoutWidget)
        self.combo_box_add_order_recipe.setObjectName("combo_box_add_order_recipe")
        self.combo_box_add_order_recipe.addItem("")
        self.combo_box_add_order_recipe.addItem("")
        self.combo_box_add_order_recipe.addItem("")
        self.grid_layout_add_order.addWidget(self.combo_box_add_order_recipe, 2, 1, 1, 1)
        self.line_edit_add_order_volume = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.line_edit_add_order_volume.setMaxLength(13)
        self.line_edit_add_order_volume.setObjectName("line_edit_add_order_volume")
        self.grid_layout_add_order.addWidget(self.line_edit_add_order_volume, 3, 1, 1, 1)
        ...
        self.grid_layout_add_order.addWidget(self.lbl_add_order_volume, 3, 0, 1, 1)
        ...
        self.line_edit_add_order_id = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.line_edit_add_order_id.setMaxLength(13)
        self.line_edit_add_order_id.setObjectName("line_edit_add_order_id")
        self.grid_layout_add_order.addWidget(self.line_edit_add_order_id, 1, 1, 1, 1)
        ...
        self.vert_layout_inv_management.addWidget(self.btn_add_order, 0, QtCore.Qt.AlignLeft)
        ...
        self.hori_layout_dispatch_order.setObjectName("hori_layout_dispatch_order")
        self.lbl_dispatch_order_id = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.lbl_dispatch_order_id.setObjectName("lbl_dispatch_order_id")
        self.hori_layout_dispatch_order.addWidget(self.lbl_dispatch_order_id, 0, QtCore.Qt.AlignLeft)
        self.line_edit_dispatch_order_id = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.line_edit_dispatch_order_id.setMaxLength(13)
        self.line_edit_dispatch_order_id.setObjectName("line_edit_dispatch_order_id")
        self.hori_layout_dispatch_order.addWidget(self.line_edit_dispatch_order_id, 0, QtCore.Qt.AlignLeft)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.hori_layout_dispatch_order.addItem(spacerItem1)
        self.vert_layout_inv_management.addLayout(self.hori_layout_dispatch_order)
        self.btn_dispatch_order = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.btn_dispatch_order.setObjectName("btn_dispatch_order")
        self.vert_layout_inv_management.addWidget(self.btn_dispatch_order, 0, QtCore.Qt.AlignLeft)
        self.hori_line_dispatch_order = QtWidgets.QFrame(self.verticalLayoutWidget)
        ...
        self.vert_layout_inv_management.addWidget(self.hori_line_dispatch_order)
    ...
    def retranslateUi(self, dialog_inv_management):
        ...
        dialog_inv_management.setWindowTitle(_translate("dialog_inv_management", "Inventory Management - Barnaby\'s Brewhouse"))
        self.lbl_inv_management.setText(_translate("dialog_inv_management", "Inventory Management"))
        self.lbl_inv.setText(_translate("dialog_inv_management", "Inventory"))
        self.lbl_red_helles_inv.setText(_translate("dialog_inv_management", "Organic Red Helles: "))
        self.lbl_pilsner_inv.setText(_translate("dialog_inv_management", "Organic Pilsner: "))
        self.lbl_dunkel_inv.setText(_translate("dialog_inv_management", "Organic Dunkel: "))
        self.lbl_update_inv.setText(_translate("dialog_inv_management", "Update Inventory"))
        self.lbl_update_inv_volume.setText(_translate("dialog_inv_management", "Volume (L):"))
        self.lbl_update_inv_recipe.setText(_translate("dialog_inv_management", "Beer Recipe:"))
        self.combo_box_update_inv_recipe.setItemText(0, _translate("dialog_inv_management", "Organic Red Helles"))
        self.combo_box_update_inv_recipe.setItemText(1, _translate("dialog_inv_management", "Organic Pilsner"))
        self.combo_box_update_inv_recipe.setItemText(2, _translate("dialog_inv_management", "Organic Dunkel"))
        self.btn_add_inv.setText(_translate("dialog_inv_management", "Add to Inventory"))
        self.btn_remove_inv.setText(_translate("dialog_inv_management", "Remove from Inventory"))
        self.lbl_customer_orders.setText(_translate("dialog_inv_management", "Customer Orders"))
        self.lbl_add_order.setText(_translate("dialog_inv_management", "Add Customer Order"))
        self.lbl_add_order_recipe.setText(_translate("dialog_inv_management", "Beer Recipe:"))
        self.combo_box_add_order_recipe.setItemText(0, _translate("dialog_inv_management", "Organic Red Helles"))
        self.combo_box_add_order_recipe.setItemText(1, _translate("dialog_inv_management", "Organic Pilsner"))
        self.combo_box_add_order_recipe.setItemText(2, _translate("dialog_inv_management", "Organic Dunkel"))
        self.lbl_add_order_volume.setText(_translate("dialog_inv_management", "Volume (L):"))
        self.lbl_add_order_id.setText(_translate("dialog_inv_management", "Order ID:"))
        self.btn_add_order.setText(_translate("dialog_inv_management", "Add Order"))
        self.lbl_dispatch_order.setText(_translate("dialog_inv_management", "Dispatch Customer Order"))
        self.lbl_dispatch_order_id.setText(_translate("dialog_inv_management", "Order ID:"))
        self.btn_dispatch_order.setText(_translate("dialog_inv_management", "Dispatch Order"))
        self.lbl_order_message.setText(_translate("dialog_inv_management", " "))
