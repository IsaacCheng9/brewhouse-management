...
# Form implementation generated from reading ui file 'inv_management_setup.ui'
#
...
class Ui_dialog_inv_management(object):
    def setupUi(self, dialog_inv_management):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 321, 311))
        ...
        self.grid_layout_add_inv.addWidget(self.lbl_add_inv_volume, 2, 0, 1, 1)
        ...
        self.grid_layout_add_inv.addWidget(self.lbl_add_inv_recipe, 1, 0, 1, 1)
        ...
        self.combo_box_add_inv_recipe.addItem("")
        self.combo_box_add_inv_recipe.addItem("")
        self.grid_layout_add_inv.addWidget(self.combo_box_add_inv_recipe, 1, 1, 1, 1)
        self.line_edit_add_inv_volume = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.line_edit_add_inv_volume.setMaxLength(13)
        self.line_edit_add_inv_volume.setObjectName("line_edit_add_inv_volume")
        self.grid_layout_add_inv.addWidget(self.line_edit_add_inv_volume, 2, 1, 1, 1)
        self.vert_layout_inv_management.addLayout(self.grid_layout_add_inv)
        self.btn_add_inv = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.btn_add_inv.setObjectName("btn_add_inv")
        self.vert_layout_inv_management.addWidget(self.btn_add_inv, 0, QtCore.Qt.AlignLeft)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.vert_layout_inv_management.addItem(spacerItem)
    ...
    def retranslateUi(self, dialog_inv_management):
        ...
        self.lbl_add_inv_volume.setText(_translate("dialog_inv_management", "Volume (L):"))
        self.lbl_add_inv_recipe.setText(_translate("dialog_inv_management", "Beer Recipe:"))
        self.combo_box_add_inv_recipe.setItemText(0, _translate("dialog_inv_management", "Organic Red Helles"))
        self.combo_box_add_inv_recipe.setItemText(1, _translate("dialog_inv_management", "Organic Pilsner"))
        self.combo_box_add_inv_recipe.setItemText(2, _translate("dialog_inv_management", "Organic Dunkel"))
