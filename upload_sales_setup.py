...
class Ui_dialog_upload_sales(object):
    def setupUi(self, dialog_upload_sales):
        ...
        self.scroll_area_widget_contents.setGeometry(QtCore.QRect(0, 0, 578, 353))
        ...
        self.vert_layout_upload_sales = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        ...
        self.hori_line_upload_sales = QtWidgets.QFrame(self.verticalLayoutWidget)
        ...
        self.date_edit_sale_date = QtWidgets.QDateEdit(self.verticalLayoutWidget)
        self.date_edit_sale_date.setDateTime(QtCore.QDateTime(QtCore.QDate(2019, 11, 1), QtCore.QTime(0, 0, 0)))
        self.date_edit_sale_date.setMaximumDateTime(QtCore.QDateTime(QtCore.QDate(9999, 1, 1), QtCore.QTime(23, 59, 59)))
        self.date_edit_sale_date.setMinimumDateTime(QtCore.QDateTime(QtCore.QDate(2000, 1, 1), QtCore.QTime(0, 0, 0)))
        ...
        self.grid_layout_upload_sales.addWidget(self.date_edit_sale_date, 3, 1, 1, 1)
        self.lbl_sale_recipe = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.lbl_sale_recipe.setObjectName("lbl_sale_recipe")
        self.grid_layout_upload_sales.addWidget(self.lbl_sale_recipe, 4, 0, 1, 1)
        self.combo_box_sale_recipe = QtWidgets.QComboBox(self.verticalLayoutWidget)
        self.combo_box_sale_recipe.setObjectName("combo_box_sale_recipe")
        self.combo_box_sale_recipe.addItem("")
        self.combo_box_sale_recipe.addItem("")
        self.combo_box_sale_recipe.addItem("")
        self.grid_layout_upload_sales.addWidget(self.combo_box_sale_recipe, 4, 1, 1, 1)
        self.lbl_sale_quantity = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.lbl_sale_quantity.setObjectName("lbl_sale_quantity")
        self.grid_layout_upload_sales.addWidget(self.lbl_sale_quantity, 6, 0, 1, 1)
        self.line_edit_sale_quantity = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.line_edit_sale_quantity.setMaxLength(13)
        self.line_edit_sale_quantity.setObjectName("line_edit_sale_quantity")
        self.grid_layout_upload_sales.addWidget(self.line_edit_sale_quantity, 6, 1, 1, 1)
        self.lbl_sale_invoice = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.lbl_sale_invoice.setObjectName("lbl_sale_invoice")
        self.grid_layout_upload_sales.addWidget(self.lbl_sale_invoice, 1, 0, 1, 1)
        self.line_edit_sale_invoice = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.line_edit_sale_invoice.setMaxLength(13)
        self.line_edit_sale_invoice.setObjectName("line_edit_sale_invoice")
        self.grid_layout_upload_sales.addWidget(self.line_edit_sale_invoice, 1, 1, 1, 1)
        self.lbl_sale_customer = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.lbl_sale_customer.setObjectName("lbl_sale_customer")
        self.grid_layout_upload_sales.addWidget(self.lbl_sale_customer, 2, 0, 1, 1)
        self.line_edit_sale_customer = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.line_edit_sale_customer.setMaxLength(40)
        self.line_edit_sale_customer.setObjectName("line_edit_sale_customer")
        self.grid_layout_upload_sales.addWidget(self.line_edit_sale_customer, 2, 1, 1, 1)
        ...
        self.line_edit_sale_gyle = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.line_edit_sale_gyle.setMaxLength(13)
        self.line_edit_sale_gyle.setObjectName("line_edit_sale_gyle")
        self.grid_layout_upload_sales.addWidget(self.line_edit_sale_gyle, 5, 1, 1, 1)
        ...
        self.vert_layout_upload_sales.addWidget(self.btn_upload_sale, 0, QtCore.Qt.AlignLeft)
        ...
        self.lbl_upload_successful = QtWidgets.QLabel(self.verticalLayoutWidget)
    ...
    def retranslateUi(self, dialog_upload_sales):
        ...
        dialog_upload_sales.setWindowTitle(_translate("dialog_upload_sales", "Upload New Sales Data - Barnaby\'s Brewhouse"))
        self.lbl_upload_sales.setText(_translate("dialog_upload_sales", "Upload New Sales Data"))
        self.lbl_sale_date.setText(_translate("dialog_upload_sales", "Date Required:"))
        self.lbl_sale_recipe.setText(_translate("dialog_upload_sales", "Recipe:"))
        self.combo_box_sale_recipe.setItemText(0, _translate("dialog_upload_sales", "Organic Red Helles"))
        self.combo_box_sale_recipe.setItemText(1, _translate("dialog_upload_sales", "Organic Pilsner"))
        self.combo_box_sale_recipe.setItemText(2, _translate("dialog_upload_sales", "Organic Dunkel"))
        self.lbl_sale_quantity.setText(_translate("dialog_upload_sales", "Quantity Ordered:"))
        self.lbl_sale_invoice.setText(_translate("dialog_upload_sales", "Invoice Number:"))
        self.lbl_sale_customer.setText(_translate("dialog_upload_sales", "Customer:"))
        self.lbl_sale_gyle.setText(_translate("dialog_upload_sales", "Gyle Number:"))
        self.btn_upload_sale.setText(_translate("dialog_upload_sales", "Upload New Sale"))
