...
class Ui_mwindow_brewhouse(object):
    def setupUi(self, mwindow_brewhouse):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(11, 11, 516, 653))
        ...
        self.lbl_predict_date_2 = QtWidgets.QLabel(self.layoutWidget)
        self.lbl_predict_date_2.setObjectName("lbl_predict_date_2")
        self.grid_layout_predict.addWidget(self.lbl_predict_date_2, 1, 0, 1, 1, QtCore.Qt.AlignLeft)
        self.date_edit_predict_2 = QtWidgets.QDateEdit(self.layoutWidget)
        self.date_edit_predict_2.setMinimumDateTime(QtCore.QDateTime(QtCore.QDate(2019, 10, 31), QtCore.QTime(0, 0, 0)))
        self.date_edit_predict_2.setCalendarPopup(True)
        self.date_edit_predict_2.setObjectName("date_edit_predict_2")
        self.grid_layout_predict.addWidget(self.date_edit_predict_2, 1, 1, 1, 1)
        ...
        self.hori_layout_predict_result = QtWidgets.QHBoxLayout()
        self.hori_layout_predict_result.setObjectName("hori_layout_predict_result")
        self.lbl_predict_result = QtWidgets.QLabel(self.layoutWidget)
        self.lbl_predict_result.setObjectName("lbl_predict_result")
        self.hori_layout_predict_result.addWidget(self.lbl_predict_result)
        self.vert_layout_brewhouse.addLayout(self.hori_layout_predict_result)
        self.btn_predict_2 = QtWidgets.QPushButton(self.layoutWidget)
        self.btn_predict_2.setObjectName("btn_predict_2")
        self.vert_layout_brewhouse.addWidget(self.btn_predict_2, 0, QtCore.Qt.AlignLeft)
    ...
    def retranslateUi(self, mwindow_brewhouse):
        ...
        self.lbl_predict_date_2.setText(_translate("mwindow_brewhouse", "Date (DD/MM/YYYY):"))
        ...
        self.btn_predict_2.setText(_translate("mwindow_brewhouse", "Update Sales Prediction"))
